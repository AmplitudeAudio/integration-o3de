...
namespace SparkyStudios::Audio::Amplitude
{
    void AmplitudeAudioControlBuilderComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        {
            serializeContext->Class<AmplitudeAudioControlBuilderComponent, AZ::Component>()
                ->Version(1)
    ...
    void AmplitudeAudioControlBuilderComponent::Activate()
    {
        ...
        builderDescriptor.m_patterns.push_back(AssetBuilderSDK::AssetBuilderPattern("(.*libs\\/gameaudio\\/" AMPLITUDE_ASSETS_DIR_NAME "\\/).*\\.xml", AssetBuilderSDK::AssetBuilderPattern::PatternType::Regex));
        builderDescriptor.m_busId = azrtti_typeid<AmplitudeAudioControlBuilderWorker>();
        builderDescriptor.m_version = 2;
        builderDescriptor.m_createJobFunction = AZStd::bind(&AmplitudeAudioControlBuilderWorker::CreateJobs, &m_audioControlBuilder, AZStd::placeholders::_1, AZStd::placeholders::_2);
        builderDescriptor.m_processJobFunction = AZStd::bind(&AmplitudeAudioControlBuilderWorker::ProcessJob, &m_audioControlBuilder, AZStd::placeholders::_1, AZStd::placeholders::_2);
